...
//	메소드 레벨
	@PostMapping("/login")
//  두개 합치면 @RequestMapping(value = "/member/login", method = RequestMethod.POST)와 동일한 효과
...
//		return "common/errorPage";
//	}
	// com.kh.spring.common.exception.ExceptionController
	// 장소 이전
}
